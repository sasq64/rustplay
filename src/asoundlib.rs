...
pub const SND_LIB_SUBMINOR: u32 = 6;
pub const SND_LIB_EXTRAVER: u32 = 1000000;
pub const SND_LIB_VERSION: u32 = 65798;
pub const SND_LIB_VERSION_STR: &'static [u8; 6usize] = b"1.1.6\0";
...
pub const _snd_input_type_SND_INPUT_STDIO: _snd_input_type = 0;
pub const _snd_input_type_SND_INPUT_BUFFER: _snd_input_type = 1;
...
pub const _snd_output_type_SND_OUTPUT_STDIO: _snd_output_type = 0;
pub const _snd_output_type_SND_OUTPUT_BUFFER: _snd_output_type = 1;
...
pub const _snd_config_type_SND_CONFIG_TYPE_INTEGER: _snd_config_type = 0;
pub const _snd_config_type_SND_CONFIG_TYPE_INTEGER64: _snd_config_type = 1;
pub const _snd_config_type_SND_CONFIG_TYPE_REAL: _snd_config_type = 2;
pub const _snd_config_type_SND_CONFIG_TYPE_STRING: _snd_config_type = 3;
pub const _snd_config_type_SND_CONFIG_TYPE_POINTER: _snd_config_type = 4;
pub const _snd_config_type_SND_CONFIG_TYPE_COMPOUND: _snd_config_type = 1024;
...
pub const _snd_pcm_class_SND_PCM_CLASS_GENERIC: _snd_pcm_class = 0;
pub const _snd_pcm_class_SND_PCM_CLASS_MULTI: _snd_pcm_class = 1;
pub const _snd_pcm_class_SND_PCM_CLASS_MODEM: _snd_pcm_class = 2;
pub const _snd_pcm_class_SND_PCM_CLASS_DIGITIZER: _snd_pcm_class = 3;
pub const _snd_pcm_class_SND_PCM_CLASS_LAST: _snd_pcm_class = 3;
pub type _snd_pcm_class = u32;
pub use self::_snd_pcm_class as snd_pcm_class_t;
pub const _snd_pcm_subclass_SND_PCM_SUBCLASS_GENERIC_MIX: _snd_pcm_subclass = 0;
pub const _snd_pcm_subclass_SND_PCM_SUBCLASS_MULTI_MIX: _snd_pcm_subclass = 1;
pub const _snd_pcm_subclass_SND_PCM_SUBCLASS_LAST: _snd_pcm_subclass = 1;
pub type _snd_pcm_subclass = u32;
pub use self::_snd_pcm_subclass as snd_pcm_subclass_t;
pub const _snd_pcm_stream_SND_PCM_STREAM_PLAYBACK: _snd_pcm_stream = 0;
pub const _snd_pcm_stream_SND_PCM_STREAM_CAPTURE: _snd_pcm_stream = 1;
pub const _snd_pcm_stream_SND_PCM_STREAM_LAST: _snd_pcm_stream = 1;
pub type _snd_pcm_stream = u32;
pub use self::_snd_pcm_stream as snd_pcm_stream_t;
pub const _snd_pcm_access_SND_PCM_ACCESS_MMAP_INTERLEAVED: _snd_pcm_access = 0;
pub const _snd_pcm_access_SND_PCM_ACCESS_MMAP_NONINTERLEAVED: _snd_pcm_access = 1;
pub const _snd_pcm_access_SND_PCM_ACCESS_MMAP_COMPLEX: _snd_pcm_access = 2;
pub const _snd_pcm_access_SND_PCM_ACCESS_RW_INTERLEAVED: _snd_pcm_access = 3;
pub const _snd_pcm_access_SND_PCM_ACCESS_RW_NONINTERLEAVED: _snd_pcm_access = 4;
pub const _snd_pcm_access_SND_PCM_ACCESS_LAST: _snd_pcm_access = 4;
pub type _snd_pcm_access = u32;
pub use self::_snd_pcm_access as snd_pcm_access_t;
pub const _snd_pcm_format_SND_PCM_FORMAT_UNKNOWN: _snd_pcm_format = -1;
pub const _snd_pcm_format_SND_PCM_FORMAT_S8: _snd_pcm_format = 0;
pub const _snd_pcm_format_SND_PCM_FORMAT_U8: _snd_pcm_format = 1;
pub const _snd_pcm_format_SND_PCM_FORMAT_S16_LE: _snd_pcm_format = 2;
pub const _snd_pcm_format_SND_PCM_FORMAT_S16_BE: _snd_pcm_format = 3;
pub const _snd_pcm_format_SND_PCM_FORMAT_U16_LE: _snd_pcm_format = 4;
pub const _snd_pcm_format_SND_PCM_FORMAT_U16_BE: _snd_pcm_format = 5;
pub const _snd_pcm_format_SND_PCM_FORMAT_S24_LE: _snd_pcm_format = 6;
pub const _snd_pcm_format_SND_PCM_FORMAT_S24_BE: _snd_pcm_format = 7;
pub const _snd_pcm_format_SND_PCM_FORMAT_U24_LE: _snd_pcm_format = 8;
pub const _snd_pcm_format_SND_PCM_FORMAT_U24_BE: _snd_pcm_format = 9;
pub const _snd_pcm_format_SND_PCM_FORMAT_S32_LE: _snd_pcm_format = 10;
pub const _snd_pcm_format_SND_PCM_FORMAT_S32_BE: _snd_pcm_format = 11;
pub const _snd_pcm_format_SND_PCM_FORMAT_U32_LE: _snd_pcm_format = 12;
pub const _snd_pcm_format_SND_PCM_FORMAT_U32_BE: _snd_pcm_format = 13;
pub const _snd_pcm_format_SND_PCM_FORMAT_FLOAT_LE: _snd_pcm_format = 14;
pub const _snd_pcm_format_SND_PCM_FORMAT_FLOAT_BE: _snd_pcm_format = 15;
pub const _snd_pcm_format_SND_PCM_FORMAT_FLOAT64_LE: _snd_pcm_format = 16;
pub const _snd_pcm_format_SND_PCM_FORMAT_FLOAT64_BE: _snd_pcm_format = 17;
pub const _snd_pcm_format_SND_PCM_FORMAT_IEC958_SUBFRAME_LE: _snd_pcm_format = 18;
pub const _snd_pcm_format_SND_PCM_FORMAT_IEC958_SUBFRAME_BE: _snd_pcm_format = 19;
pub const _snd_pcm_format_SND_PCM_FORMAT_MU_LAW: _snd_pcm_format = 20;
pub const _snd_pcm_format_SND_PCM_FORMAT_A_LAW: _snd_pcm_format = 21;
pub const _snd_pcm_format_SND_PCM_FORMAT_IMA_ADPCM: _snd_pcm_format = 22;
pub const _snd_pcm_format_SND_PCM_FORMAT_MPEG: _snd_pcm_format = 23;
pub const _snd_pcm_format_SND_PCM_FORMAT_GSM: _snd_pcm_format = 24;
pub const _snd_pcm_format_SND_PCM_FORMAT_S20_LE: _snd_pcm_format = 25;
pub const _snd_pcm_format_SND_PCM_FORMAT_S20_BE: _snd_pcm_format = 26;
pub const _snd_pcm_format_SND_PCM_FORMAT_U20_LE: _snd_pcm_format = 27;
pub const _snd_pcm_format_SND_PCM_FORMAT_U20_BE: _snd_pcm_format = 28;
pub const _snd_pcm_format_SND_PCM_FORMAT_SPECIAL: _snd_pcm_format = 31;
pub const _snd_pcm_format_SND_PCM_FORMAT_S24_3LE: _snd_pcm_format = 32;
pub const _snd_pcm_format_SND_PCM_FORMAT_S24_3BE: _snd_pcm_format = 33;
pub const _snd_pcm_format_SND_PCM_FORMAT_U24_3LE: _snd_pcm_format = 34;
pub const _snd_pcm_format_SND_PCM_FORMAT_U24_3BE: _snd_pcm_format = 35;
pub const _snd_pcm_format_SND_PCM_FORMAT_S20_3LE: _snd_pcm_format = 36;
pub const _snd_pcm_format_SND_PCM_FORMAT_S20_3BE: _snd_pcm_format = 37;
pub const _snd_pcm_format_SND_PCM_FORMAT_U20_3LE: _snd_pcm_format = 38;
pub const _snd_pcm_format_SND_PCM_FORMAT_U20_3BE: _snd_pcm_format = 39;
pub const _snd_pcm_format_SND_PCM_FORMAT_S18_3LE: _snd_pcm_format = 40;
pub const _snd_pcm_format_SND_PCM_FORMAT_S18_3BE: _snd_pcm_format = 41;
pub const _snd_pcm_format_SND_PCM_FORMAT_U18_3LE: _snd_pcm_format = 42;
pub const _snd_pcm_format_SND_PCM_FORMAT_U18_3BE: _snd_pcm_format = 43;
pub const _snd_pcm_format_SND_PCM_FORMAT_G723_24: _snd_pcm_format = 44;
pub const _snd_pcm_format_SND_PCM_FORMAT_G723_24_1B: _snd_pcm_format = 45;
pub const _snd_pcm_format_SND_PCM_FORMAT_G723_40: _snd_pcm_format = 46;
pub const _snd_pcm_format_SND_PCM_FORMAT_G723_40_1B: _snd_pcm_format = 47;
pub const _snd_pcm_format_SND_PCM_FORMAT_DSD_U8: _snd_pcm_format = 48;
pub const _snd_pcm_format_SND_PCM_FORMAT_DSD_U16_LE: _snd_pcm_format = 49;
pub const _snd_pcm_format_SND_PCM_FORMAT_DSD_U32_LE: _snd_pcm_format = 50;
pub const _snd_pcm_format_SND_PCM_FORMAT_DSD_U16_BE: _snd_pcm_format = 51;
pub const _snd_pcm_format_SND_PCM_FORMAT_DSD_U32_BE: _snd_pcm_format = 52;
pub const _snd_pcm_format_SND_PCM_FORMAT_LAST: _snd_pcm_format = 52;
pub const _snd_pcm_format_SND_PCM_FORMAT_S16: _snd_pcm_format = 2;
pub const _snd_pcm_format_SND_PCM_FORMAT_U16: _snd_pcm_format = 4;
pub const _snd_pcm_format_SND_PCM_FORMAT_S24: _snd_pcm_format = 6;
pub const _snd_pcm_format_SND_PCM_FORMAT_U24: _snd_pcm_format = 8;
pub const _snd_pcm_format_SND_PCM_FORMAT_S32: _snd_pcm_format = 10;
pub const _snd_pcm_format_SND_PCM_FORMAT_U32: _snd_pcm_format = 12;
pub const _snd_pcm_format_SND_PCM_FORMAT_FLOAT: _snd_pcm_format = 14;
pub const _snd_pcm_format_SND_PCM_FORMAT_FLOAT64: _snd_pcm_format = 16;
pub const _snd_pcm_format_SND_PCM_FORMAT_IEC958_SUBFRAME: _snd_pcm_format = 18;
pub const _snd_pcm_format_SND_PCM_FORMAT_S20: _snd_pcm_format = 25;
pub const _snd_pcm_format_SND_PCM_FORMAT_U20: _snd_pcm_format = 27;
pub type _snd_pcm_format = i32;
pub use self::_snd_pcm_format as snd_pcm_format_t;
pub const _snd_pcm_subformat_SND_PCM_SUBFORMAT_STD: _snd_pcm_subformat = 0;
pub const _snd_pcm_subformat_SND_PCM_SUBFORMAT_LAST: _snd_pcm_subformat = 0;
pub type _snd_pcm_subformat = u32;
pub use self::_snd_pcm_subformat as snd_pcm_subformat_t;
pub const _snd_pcm_state_SND_PCM_STATE_OPEN: _snd_pcm_state = 0;
pub const _snd_pcm_state_SND_PCM_STATE_SETUP: _snd_pcm_state = 1;
pub const _snd_pcm_state_SND_PCM_STATE_PREPARED: _snd_pcm_state = 2;
pub const _snd_pcm_state_SND_PCM_STATE_RUNNING: _snd_pcm_state = 3;
pub const _snd_pcm_state_SND_PCM_STATE_XRUN: _snd_pcm_state = 4;
pub const _snd_pcm_state_SND_PCM_STATE_DRAINING: _snd_pcm_state = 5;
pub const _snd_pcm_state_SND_PCM_STATE_PAUSED: _snd_pcm_state = 6;
pub const _snd_pcm_state_SND_PCM_STATE_SUSPENDED: _snd_pcm_state = 7;
pub const _snd_pcm_state_SND_PCM_STATE_DISCONNECTED: _snd_pcm_state = 8;
pub const _snd_pcm_state_SND_PCM_STATE_LAST: _snd_pcm_state = 8;
pub const _snd_pcm_state_SND_PCM_STATE_PRIVATE1: _snd_pcm_state = 1024;
pub type _snd_pcm_state = u32;
pub use self::_snd_pcm_state as snd_pcm_state_t;
pub const _snd_pcm_start_SND_PCM_START_DATA: _snd_pcm_start = 0;
pub const _snd_pcm_start_SND_PCM_START_EXPLICIT: _snd_pcm_start = 1;
pub const _snd_pcm_start_SND_PCM_START_LAST: _snd_pcm_start = 1;
pub type _snd_pcm_start = u32;
pub use self::_snd_pcm_start as snd_pcm_start_t;
pub const _snd_pcm_xrun_SND_PCM_XRUN_NONE: _snd_pcm_xrun = 0;
pub const _snd_pcm_xrun_SND_PCM_XRUN_STOP: _snd_pcm_xrun = 1;
pub const _snd_pcm_xrun_SND_PCM_XRUN_LAST: _snd_pcm_xrun = 1;
pub type _snd_pcm_xrun = u32;
pub use self::_snd_pcm_xrun as snd_pcm_xrun_t;
pub const _snd_pcm_tstamp_SND_PCM_TSTAMP_NONE: _snd_pcm_tstamp = 0;
pub const _snd_pcm_tstamp_SND_PCM_TSTAMP_ENABLE: _snd_pcm_tstamp = 1;
pub const _snd_pcm_tstamp_SND_PCM_TSTAMP_MMAP: _snd_pcm_tstamp = 1;
pub const _snd_pcm_tstamp_SND_PCM_TSTAMP_LAST: _snd_pcm_tstamp = 1;
pub type _snd_pcm_tstamp = u32;
pub use self::_snd_pcm_tstamp as snd_pcm_tstamp_t;
pub const _snd_pcm_tstamp_type_SND_PCM_TSTAMP_TYPE_GETTIMEOFDAY: _snd_pcm_tstamp_type = 0;
pub const _snd_pcm_tstamp_type_SND_PCM_TSTAMP_TYPE_MONOTONIC: _snd_pcm_tstamp_type = 1;
pub const _snd_pcm_tstamp_type_SND_PCM_TSTAMP_TYPE_MONOTONIC_RAW: _snd_pcm_tstamp_type = 2;
pub const _snd_pcm_tstamp_type_SND_PCM_TSTAMP_TYPE_LAST: _snd_pcm_tstamp_type = 2;
...
pub const _snd_pcm_type_SND_PCM_TYPE_HW: _snd_pcm_type = 0;
pub const _snd_pcm_type_SND_PCM_TYPE_HOOKS: _snd_pcm_type = 1;
pub const _snd_pcm_type_SND_PCM_TYPE_MULTI: _snd_pcm_type = 2;
pub const _snd_pcm_type_SND_PCM_TYPE_FILE: _snd_pcm_type = 3;
pub const _snd_pcm_type_SND_PCM_TYPE_NULL: _snd_pcm_type = 4;
pub const _snd_pcm_type_SND_PCM_TYPE_SHM: _snd_pcm_type = 5;
pub const _snd_pcm_type_SND_PCM_TYPE_INET: _snd_pcm_type = 6;
pub const _snd_pcm_type_SND_PCM_TYPE_COPY: _snd_pcm_type = 7;
pub const _snd_pcm_type_SND_PCM_TYPE_LINEAR: _snd_pcm_type = 8;
pub const _snd_pcm_type_SND_PCM_TYPE_ALAW: _snd_pcm_type = 9;
pub const _snd_pcm_type_SND_PCM_TYPE_MULAW: _snd_pcm_type = 10;
pub const _snd_pcm_type_SND_PCM_TYPE_ADPCM: _snd_pcm_type = 11;
pub const _snd_pcm_type_SND_PCM_TYPE_RATE: _snd_pcm_type = 12;
pub const _snd_pcm_type_SND_PCM_TYPE_ROUTE: _snd_pcm_type = 13;
pub const _snd_pcm_type_SND_PCM_TYPE_PLUG: _snd_pcm_type = 14;
pub const _snd_pcm_type_SND_PCM_TYPE_SHARE: _snd_pcm_type = 15;
pub const _snd_pcm_type_SND_PCM_TYPE_METER: _snd_pcm_type = 16;
pub const _snd_pcm_type_SND_PCM_TYPE_MIX: _snd_pcm_type = 17;
pub const _snd_pcm_type_SND_PCM_TYPE_DROUTE: _snd_pcm_type = 18;
pub const _snd_pcm_type_SND_PCM_TYPE_LBSERVER: _snd_pcm_type = 19;
pub const _snd_pcm_type_SND_PCM_TYPE_LINEAR_FLOAT: _snd_pcm_type = 20;
pub const _snd_pcm_type_SND_PCM_TYPE_LADSPA: _snd_pcm_type = 21;
pub const _snd_pcm_type_SND_PCM_TYPE_DMIX: _snd_pcm_type = 22;
pub const _snd_pcm_type_SND_PCM_TYPE_JACK: _snd_pcm_type = 23;
pub const _snd_pcm_type_SND_PCM_TYPE_DSNOOP: _snd_pcm_type = 24;
pub const _snd_pcm_type_SND_PCM_TYPE_DSHARE: _snd_pcm_type = 25;
pub const _snd_pcm_type_SND_PCM_TYPE_IEC958: _snd_pcm_type = 26;
pub const _snd_pcm_type_SND_PCM_TYPE_SOFTVOL: _snd_pcm_type = 27;
pub const _snd_pcm_type_SND_PCM_TYPE_IOPLUG: _snd_pcm_type = 28;
pub const _snd_pcm_type_SND_PCM_TYPE_EXTPLUG: _snd_pcm_type = 29;
pub const _snd_pcm_type_SND_PCM_TYPE_MMAP_EMUL: _snd_pcm_type = 30;
pub const _snd_pcm_type_SND_PCM_TYPE_LAST: _snd_pcm_type = 30;
...
pub const snd_pcm_chmap_type_SND_CHMAP_TYPE_NONE: snd_pcm_chmap_type = 0;
pub const snd_pcm_chmap_type_SND_CHMAP_TYPE_FIXED: snd_pcm_chmap_type = 1;
pub const snd_pcm_chmap_type_SND_CHMAP_TYPE_VAR: snd_pcm_chmap_type = 2;
pub const snd_pcm_chmap_type_SND_CHMAP_TYPE_PAIRED: snd_pcm_chmap_type = 3;
pub const snd_pcm_chmap_type_SND_CHMAP_TYPE_LAST: snd_pcm_chmap_type = 3;
pub type snd_pcm_chmap_type = u32;
pub const snd_pcm_chmap_position_SND_CHMAP_UNKNOWN: snd_pcm_chmap_position = 0;
pub const snd_pcm_chmap_position_SND_CHMAP_NA: snd_pcm_chmap_position = 1;
pub const snd_pcm_chmap_position_SND_CHMAP_MONO: snd_pcm_chmap_position = 2;
pub const snd_pcm_chmap_position_SND_CHMAP_FL: snd_pcm_chmap_position = 3;
pub const snd_pcm_chmap_position_SND_CHMAP_FR: snd_pcm_chmap_position = 4;
pub const snd_pcm_chmap_position_SND_CHMAP_RL: snd_pcm_chmap_position = 5;
pub const snd_pcm_chmap_position_SND_CHMAP_RR: snd_pcm_chmap_position = 6;
pub const snd_pcm_chmap_position_SND_CHMAP_FC: snd_pcm_chmap_position = 7;
pub const snd_pcm_chmap_position_SND_CHMAP_LFE: snd_pcm_chmap_position = 8;
pub const snd_pcm_chmap_position_SND_CHMAP_SL: snd_pcm_chmap_position = 9;
pub const snd_pcm_chmap_position_SND_CHMAP_SR: snd_pcm_chmap_position = 10;
pub const snd_pcm_chmap_position_SND_CHMAP_RC: snd_pcm_chmap_position = 11;
pub const snd_pcm_chmap_position_SND_CHMAP_FLC: snd_pcm_chmap_position = 12;
pub const snd_pcm_chmap_position_SND_CHMAP_FRC: snd_pcm_chmap_position = 13;
pub const snd_pcm_chmap_position_SND_CHMAP_RLC: snd_pcm_chmap_position = 14;
pub const snd_pcm_chmap_position_SND_CHMAP_RRC: snd_pcm_chmap_position = 15;
pub const snd_pcm_chmap_position_SND_CHMAP_FLW: snd_pcm_chmap_position = 16;
pub const snd_pcm_chmap_position_SND_CHMAP_FRW: snd_pcm_chmap_position = 17;
pub const snd_pcm_chmap_position_SND_CHMAP_FLH: snd_pcm_chmap_position = 18;
pub const snd_pcm_chmap_position_SND_CHMAP_FCH: snd_pcm_chmap_position = 19;
pub const snd_pcm_chmap_position_SND_CHMAP_FRH: snd_pcm_chmap_position = 20;
pub const snd_pcm_chmap_position_SND_CHMAP_TC: snd_pcm_chmap_position = 21;
pub const snd_pcm_chmap_position_SND_CHMAP_TFL: snd_pcm_chmap_position = 22;
pub const snd_pcm_chmap_position_SND_CHMAP_TFR: snd_pcm_chmap_position = 23;
pub const snd_pcm_chmap_position_SND_CHMAP_TFC: snd_pcm_chmap_position = 24;
pub const snd_pcm_chmap_position_SND_CHMAP_TRL: snd_pcm_chmap_position = 25;
pub const snd_pcm_chmap_position_SND_CHMAP_TRR: snd_pcm_chmap_position = 26;
pub const snd_pcm_chmap_position_SND_CHMAP_TRC: snd_pcm_chmap_position = 27;
pub const snd_pcm_chmap_position_SND_CHMAP_TFLC: snd_pcm_chmap_position = 28;
pub const snd_pcm_chmap_position_SND_CHMAP_TFRC: snd_pcm_chmap_position = 29;
pub const snd_pcm_chmap_position_SND_CHMAP_TSL: snd_pcm_chmap_position = 30;
pub const snd_pcm_chmap_position_SND_CHMAP_TSR: snd_pcm_chmap_position = 31;
pub const snd_pcm_chmap_position_SND_CHMAP_LLFE: snd_pcm_chmap_position = 32;
pub const snd_pcm_chmap_position_SND_CHMAP_RLFE: snd_pcm_chmap_position = 33;
pub const snd_pcm_chmap_position_SND_CHMAP_BC: snd_pcm_chmap_position = 34;
pub const snd_pcm_chmap_position_SND_CHMAP_BLC: snd_pcm_chmap_position = 35;
pub const snd_pcm_chmap_position_SND_CHMAP_BRC: snd_pcm_chmap_position = 36;
pub const snd_pcm_chmap_position_SND_CHMAP_LAST: snd_pcm_chmap_position = 36;
...
pub const _snd_pcm_hook_type_SND_PCM_HOOK_TYPE_HW_PARAMS: _snd_pcm_hook_type = 0;
pub const _snd_pcm_hook_type_SND_PCM_HOOK_TYPE_HW_FREE: _snd_pcm_hook_type = 1;
pub const _snd_pcm_hook_type_SND_PCM_HOOK_TYPE_CLOSE: _snd_pcm_hook_type = 2;
pub const _snd_pcm_hook_type_SND_PCM_HOOK_TYPE_LAST: _snd_pcm_hook_type = 2;
...
pub const _snd_spcm_latency_SND_SPCM_LATENCY_STANDARD: _snd_spcm_latency = 0;
pub const _snd_spcm_latency_SND_SPCM_LATENCY_MEDIUM: _snd_spcm_latency = 1;
pub const _snd_spcm_latency_SND_SPCM_LATENCY_REALTIME: _snd_spcm_latency = 2;
pub type _snd_spcm_latency = u32;
pub use self::_snd_spcm_latency as snd_spcm_latency_t;
pub const _snd_spcm_xrun_type_SND_SPCM_XRUN_IGNORE: _snd_spcm_xrun_type = 0;
pub const _snd_spcm_xrun_type_SND_SPCM_XRUN_STOP: _snd_spcm_xrun_type = 1;
pub type _snd_spcm_xrun_type = u32;
pub use self::_snd_spcm_xrun_type as snd_spcm_xrun_type_t;
pub const _snd_spcm_duplex_type_SND_SPCM_DUPLEX_LIBERAL: _snd_spcm_duplex_type = 0;
pub const _snd_spcm_duplex_type_SND_SPCM_DUPLEX_PEDANTIC: _snd_spcm_duplex_type = 1;
...
pub const _snd_rawmidi_stream_SND_RAWMIDI_STREAM_OUTPUT: _snd_rawmidi_stream = 0;
pub const _snd_rawmidi_stream_SND_RAWMIDI_STREAM_INPUT: _snd_rawmidi_stream = 1;
pub const _snd_rawmidi_stream_SND_RAWMIDI_STREAM_LAST: _snd_rawmidi_stream = 1;
...
pub const _snd_rawmidi_type_SND_RAWMIDI_TYPE_HW: _snd_rawmidi_type = 0;
pub const _snd_rawmidi_type_SND_RAWMIDI_TYPE_SHM: _snd_rawmidi_type = 1;
pub const _snd_rawmidi_type_SND_RAWMIDI_TYPE_INET: _snd_rawmidi_type = 2;
pub const _snd_rawmidi_type_SND_RAWMIDI_TYPE_VIRTUAL: _snd_rawmidi_type = 3;
...
pub const _snd_timer_class_SND_TIMER_CLASS_NONE: _snd_timer_class = -1;
pub const _snd_timer_class_SND_TIMER_CLASS_SLAVE: _snd_timer_class = 0;
pub const _snd_timer_class_SND_TIMER_CLASS_GLOBAL: _snd_timer_class = 1;
pub const _snd_timer_class_SND_TIMER_CLASS_CARD: _snd_timer_class = 2;
pub const _snd_timer_class_SND_TIMER_CLASS_PCM: _snd_timer_class = 3;
pub const _snd_timer_class_SND_TIMER_CLASS_LAST: _snd_timer_class = 3;
pub type _snd_timer_class = i32;
pub use self::_snd_timer_class as snd_timer_class_t;
pub const _snd_timer_slave_class_SND_TIMER_SCLASS_NONE: _snd_timer_slave_class = 0;
pub const _snd_timer_slave_class_SND_TIMER_SCLASS_APPLICATION: _snd_timer_slave_class = 1;
pub const _snd_timer_slave_class_SND_TIMER_SCLASS_SEQUENCER: _snd_timer_slave_class = 2;
pub const _snd_timer_slave_class_SND_TIMER_SCLASS_OSS_SEQUENCER: _snd_timer_slave_class = 3;
pub const _snd_timer_slave_class_SND_TIMER_SCLASS_LAST: _snd_timer_slave_class = 3;
pub type _snd_timer_slave_class = u32;
pub use self::_snd_timer_slave_class as snd_timer_slave_class_t;
pub const _snd_timer_event_SND_TIMER_EVENT_RESOLUTION: _snd_timer_event = 0;
pub const _snd_timer_event_SND_TIMER_EVENT_TICK: _snd_timer_event = 1;
pub const _snd_timer_event_SND_TIMER_EVENT_START: _snd_timer_event = 2;
pub const _snd_timer_event_SND_TIMER_EVENT_STOP: _snd_timer_event = 3;
pub const _snd_timer_event_SND_TIMER_EVENT_CONTINUE: _snd_timer_event = 4;
pub const _snd_timer_event_SND_TIMER_EVENT_PAUSE: _snd_timer_event = 5;
pub const _snd_timer_event_SND_TIMER_EVENT_EARLY: _snd_timer_event = 6;
pub const _snd_timer_event_SND_TIMER_EVENT_SUSPEND: _snd_timer_event = 7;
pub const _snd_timer_event_SND_TIMER_EVENT_RESUME: _snd_timer_event = 8;
pub const _snd_timer_event_SND_TIMER_EVENT_MSTART: _snd_timer_event = 12;
pub const _snd_timer_event_SND_TIMER_EVENT_MSTOP: _snd_timer_event = 13;
pub const _snd_timer_event_SND_TIMER_EVENT_MCONTINUE: _snd_timer_event = 14;
pub const _snd_timer_event_SND_TIMER_EVENT_MPAUSE: _snd_timer_event = 15;
pub const _snd_timer_event_SND_TIMER_EVENT_MSUSPEND: _snd_timer_event = 17;
pub const _snd_timer_event_SND_TIMER_EVENT_MRESUME: _snd_timer_event = 18;
...
pub const _snd_timer_type_SND_TIMER_TYPE_HW: _snd_timer_type = 0;
pub const _snd_timer_type_SND_TIMER_TYPE_SHM: _snd_timer_type = 1;
pub const _snd_timer_type_SND_TIMER_TYPE_INET: _snd_timer_type = 2;
...
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_OPL2: _snd_hwdep_iface = 0;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_OPL3: _snd_hwdep_iface = 1;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_OPL4: _snd_hwdep_iface = 2;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_SB16CSP: _snd_hwdep_iface = 3;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_EMU10K1: _snd_hwdep_iface = 4;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_YSS225: _snd_hwdep_iface = 5;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_ICS2115: _snd_hwdep_iface = 6;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_SSCAPE: _snd_hwdep_iface = 7;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_VX: _snd_hwdep_iface = 8;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_MIXART: _snd_hwdep_iface = 9;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_USX2Y: _snd_hwdep_iface = 10;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_EMUX_WAVETABLE: _snd_hwdep_iface = 11;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_BLUETOOTH: _snd_hwdep_iface = 12;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_USX2Y_PCM: _snd_hwdep_iface = 13;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_PCXHR: _snd_hwdep_iface = 14;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_SB_RC: _snd_hwdep_iface = 15;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_HDA: _snd_hwdep_iface = 16;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_USB_STREAM: _snd_hwdep_iface = 17;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_DICE: _snd_hwdep_iface = 18;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_FIREWORKS: _snd_hwdep_iface = 19;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_BEBOB: _snd_hwdep_iface = 20;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_OXFW: _snd_hwdep_iface = 21;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_DIGI00X: _snd_hwdep_iface = 22;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_TASCAM: _snd_hwdep_iface = 23;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_LINE6: _snd_hwdep_iface = 24;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_MOTU: _snd_hwdep_iface = 25;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_FW_FIREFACE: _snd_hwdep_iface = 26;
pub const _snd_hwdep_iface_SND_HWDEP_IFACE_LAST: _snd_hwdep_iface = 26;
pub type _snd_hwdep_iface = u32;
pub use self::_snd_hwdep_iface as snd_hwdep_iface_t;
pub const _snd_hwdep_type_SND_HWDEP_TYPE_HW: _snd_hwdep_type = 0;
pub const _snd_hwdep_type_SND_HWDEP_TYPE_SHM: _snd_hwdep_type = 1;
pub const _snd_hwdep_type_SND_HWDEP_TYPE_INET: _snd_hwdep_type = 2;
...
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_NONE: _snd_ctl_elem_type = 0;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_BOOLEAN: _snd_ctl_elem_type = 1;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_INTEGER: _snd_ctl_elem_type = 2;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_ENUMERATED: _snd_ctl_elem_type = 3;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_BYTES: _snd_ctl_elem_type = 4;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_IEC958: _snd_ctl_elem_type = 5;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_INTEGER64: _snd_ctl_elem_type = 6;
pub const _snd_ctl_elem_type_SND_CTL_ELEM_TYPE_LAST: _snd_ctl_elem_type = 6;
pub type _snd_ctl_elem_type = u32;
pub use self::_snd_ctl_elem_type as snd_ctl_elem_type_t;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_CARD: _snd_ctl_elem_iface = 0;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_HWDEP: _snd_ctl_elem_iface = 1;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_MIXER: _snd_ctl_elem_iface = 2;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_PCM: _snd_ctl_elem_iface = 3;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_RAWMIDI: _snd_ctl_elem_iface = 4;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_TIMER: _snd_ctl_elem_iface = 5;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_SEQUENCER: _snd_ctl_elem_iface = 6;
pub const _snd_ctl_elem_iface_SND_CTL_ELEM_IFACE_LAST: _snd_ctl_elem_iface = 6;
pub type _snd_ctl_elem_iface = u32;
pub use self::_snd_ctl_elem_iface as snd_ctl_elem_iface_t;
pub const _snd_ctl_event_type_SND_CTL_EVENT_ELEM: _snd_ctl_event_type = 0;
pub const _snd_ctl_event_type_SND_CTL_EVENT_LAST: _snd_ctl_event_type = 0;
pub type _snd_ctl_event_type = u32;
pub use self::_snd_ctl_event_type as snd_ctl_event_type_t;
pub const _snd_ctl_type_SND_CTL_TYPE_HW: _snd_ctl_type = 0;
pub const _snd_ctl_type_SND_CTL_TYPE_SHM: _snd_ctl_type = 1;
pub const _snd_ctl_type_SND_CTL_TYPE_INET: _snd_ctl_type = 2;
pub const _snd_ctl_type_SND_CTL_TYPE_EXT: _snd_ctl_type = 3;
...
>;
pub const _snd_mixer_elem_type_SND_MIXER_ELEM_SIMPLE: _snd_mixer_elem_type = 0;
pub const _snd_mixer_elem_type_SND_MIXER_ELEM_LAST: _snd_mixer_elem_type = 0;
...
extern "C" {
    pub fn snd_mixer_class_set_private_free(
        class_: *mut snd_mixer_class_t,
        private_free: ::std::option::Option<unsafe extern "C" fn(class_: *mut snd_mixer_class_t)>,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_UNKNOWN: _snd_mixer_selem_channel_id = -1;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_FRONT_LEFT: _snd_mixer_selem_channel_id = 0;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_FRONT_RIGHT: _snd_mixer_selem_channel_id = 1;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_REAR_LEFT: _snd_mixer_selem_channel_id = 2;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_REAR_RIGHT: _snd_mixer_selem_channel_id = 3;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_FRONT_CENTER: _snd_mixer_selem_channel_id = 4;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_WOOFER: _snd_mixer_selem_channel_id = 5;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_SIDE_LEFT: _snd_mixer_selem_channel_id = 6;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_SIDE_RIGHT: _snd_mixer_selem_channel_id = 7;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_REAR_CENTER: _snd_mixer_selem_channel_id = 8;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_LAST: _snd_mixer_selem_channel_id = 31;
pub const _snd_mixer_selem_channel_id_SND_MIXER_SCHN_MONO: _snd_mixer_selem_channel_id = 0;
pub type _snd_mixer_selem_channel_id = i32;
pub use self::_snd_mixer_selem_channel_id as snd_mixer_selem_channel_id_t;
pub const snd_mixer_selem_regopt_abstract_SND_MIXER_SABSTRACT_NONE:
    snd_mixer_selem_regopt_abstract = 0;
pub const snd_mixer_selem_regopt_abstract_SND_MIXER_SABSTRACT_BASIC:
    snd_mixer_selem_regopt_abstract = 1;
...
pub const snd_seq_event_type_SND_SEQ_EVENT_SYSTEM: snd_seq_event_type = 0;
pub const snd_seq_event_type_SND_SEQ_EVENT_RESULT: snd_seq_event_type = 1;
pub const snd_seq_event_type_SND_SEQ_EVENT_NOTE: snd_seq_event_type = 5;
pub const snd_seq_event_type_SND_SEQ_EVENT_NOTEON: snd_seq_event_type = 6;
pub const snd_seq_event_type_SND_SEQ_EVENT_NOTEOFF: snd_seq_event_type = 7;
pub const snd_seq_event_type_SND_SEQ_EVENT_KEYPRESS: snd_seq_event_type = 8;
pub const snd_seq_event_type_SND_SEQ_EVENT_CONTROLLER: snd_seq_event_type = 10;
pub const snd_seq_event_type_SND_SEQ_EVENT_PGMCHANGE: snd_seq_event_type = 11;
pub const snd_seq_event_type_SND_SEQ_EVENT_CHANPRESS: snd_seq_event_type = 12;
pub const snd_seq_event_type_SND_SEQ_EVENT_PITCHBEND: snd_seq_event_type = 13;
pub const snd_seq_event_type_SND_SEQ_EVENT_CONTROL14: snd_seq_event_type = 14;
pub const snd_seq_event_type_SND_SEQ_EVENT_NONREGPARAM: snd_seq_event_type = 15;
pub const snd_seq_event_type_SND_SEQ_EVENT_REGPARAM: snd_seq_event_type = 16;
pub const snd_seq_event_type_SND_SEQ_EVENT_SONGPOS: snd_seq_event_type = 20;
pub const snd_seq_event_type_SND_SEQ_EVENT_SONGSEL: snd_seq_event_type = 21;
pub const snd_seq_event_type_SND_SEQ_EVENT_QFRAME: snd_seq_event_type = 22;
pub const snd_seq_event_type_SND_SEQ_EVENT_TIMESIGN: snd_seq_event_type = 23;
pub const snd_seq_event_type_SND_SEQ_EVENT_KEYSIGN: snd_seq_event_type = 24;
pub const snd_seq_event_type_SND_SEQ_EVENT_START: snd_seq_event_type = 30;
pub const snd_seq_event_type_SND_SEQ_EVENT_CONTINUE: snd_seq_event_type = 31;
pub const snd_seq_event_type_SND_SEQ_EVENT_STOP: snd_seq_event_type = 32;
pub const snd_seq_event_type_SND_SEQ_EVENT_SETPOS_TICK: snd_seq_event_type = 33;
pub const snd_seq_event_type_SND_SEQ_EVENT_SETPOS_TIME: snd_seq_event_type = 34;
pub const snd_seq_event_type_SND_SEQ_EVENT_TEMPO: snd_seq_event_type = 35;
pub const snd_seq_event_type_SND_SEQ_EVENT_CLOCK: snd_seq_event_type = 36;
pub const snd_seq_event_type_SND_SEQ_EVENT_TICK: snd_seq_event_type = 37;
pub const snd_seq_event_type_SND_SEQ_EVENT_QUEUE_SKEW: snd_seq_event_type = 38;
pub const snd_seq_event_type_SND_SEQ_EVENT_SYNC_POS: snd_seq_event_type = 39;
pub const snd_seq_event_type_SND_SEQ_EVENT_TUNE_REQUEST: snd_seq_event_type = 40;
pub const snd_seq_event_type_SND_SEQ_EVENT_RESET: snd_seq_event_type = 41;
pub const snd_seq_event_type_SND_SEQ_EVENT_SENSING: snd_seq_event_type = 42;
pub const snd_seq_event_type_SND_SEQ_EVENT_ECHO: snd_seq_event_type = 50;
pub const snd_seq_event_type_SND_SEQ_EVENT_OSS: snd_seq_event_type = 51;
pub const snd_seq_event_type_SND_SEQ_EVENT_CLIENT_START: snd_seq_event_type = 60;
pub const snd_seq_event_type_SND_SEQ_EVENT_CLIENT_EXIT: snd_seq_event_type = 61;
pub const snd_seq_event_type_SND_SEQ_EVENT_CLIENT_CHANGE: snd_seq_event_type = 62;
pub const snd_seq_event_type_SND_SEQ_EVENT_PORT_START: snd_seq_event_type = 63;
pub const snd_seq_event_type_SND_SEQ_EVENT_PORT_EXIT: snd_seq_event_type = 64;
pub const snd_seq_event_type_SND_SEQ_EVENT_PORT_CHANGE: snd_seq_event_type = 65;
pub const snd_seq_event_type_SND_SEQ_EVENT_PORT_SUBSCRIBED: snd_seq_event_type = 66;
pub const snd_seq_event_type_SND_SEQ_EVENT_PORT_UNSUBSCRIBED: snd_seq_event_type = 67;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR0: snd_seq_event_type = 90;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR1: snd_seq_event_type = 91;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR2: snd_seq_event_type = 92;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR3: snd_seq_event_type = 93;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR4: snd_seq_event_type = 94;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR5: snd_seq_event_type = 95;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR6: snd_seq_event_type = 96;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR7: snd_seq_event_type = 97;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR8: snd_seq_event_type = 98;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR9: snd_seq_event_type = 99;
pub const snd_seq_event_type_SND_SEQ_EVENT_SYSEX: snd_seq_event_type = 130;
pub const snd_seq_event_type_SND_SEQ_EVENT_BOUNCE: snd_seq_event_type = 131;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR_VAR0: snd_seq_event_type = 135;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR_VAR1: snd_seq_event_type = 136;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR_VAR2: snd_seq_event_type = 137;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR_VAR3: snd_seq_event_type = 138;
pub const snd_seq_event_type_SND_SEQ_EVENT_USR_VAR4: snd_seq_event_type = 139;
pub const snd_seq_event_type_SND_SEQ_EVENT_NONE: snd_seq_event_type = 255;
...
pub const _snd_seq_type_SND_SEQ_TYPE_HW: _snd_seq_type = 0;
pub const _snd_seq_type_SND_SEQ_TYPE_SHM: _snd_seq_type = 1;
pub const _snd_seq_type_SND_SEQ_TYPE_INET: _snd_seq_type = 2;
...
pub const snd_seq_client_type_SND_SEQ_USER_CLIENT: snd_seq_client_type = 1;
pub const snd_seq_client_type_SND_SEQ_KERNEL_CLIENT: snd_seq_client_type = 2;
...
pub const snd_seq_query_subs_type_t_SND_SEQ_QUERY_SUBS_READ: snd_seq_query_subs_type_t = 0;
pub const snd_seq_query_subs_type_t_SND_SEQ_QUERY_SUBS_WRITE: snd_seq_query_subs_type_t = 1;
...
pub const snd_seq_queue_timer_type_t_SND_SEQ_TIMER_ALSA: snd_seq_queue_timer_type_t = 0;
pub const snd_seq_queue_timer_type_t_SND_SEQ_TIMER_MIDI_CLOCK: snd_seq_queue_timer_type_t = 1;
pub const snd_seq_queue_timer_type_t_SND_SEQ_TIMER_MIDI_TICK: snd_seq_queue_timer_type_t = 2;
...
pub const SND_SEQ_EVFLG_RESULT: _bindgen_ty_4 = 0;
pub const SND_SEQ_EVFLG_NOTE: _bindgen_ty_4 = 1;
pub const SND_SEQ_EVFLG_CONTROL: _bindgen_ty_4 = 2;
pub const SND_SEQ_EVFLG_QUEUE: _bindgen_ty_4 = 3;
pub const SND_SEQ_EVFLG_SYSTEM: _bindgen_ty_4 = 4;
pub const SND_SEQ_EVFLG_MESSAGE: _bindgen_ty_4 = 5;
pub const SND_SEQ_EVFLG_CONNECTION: _bindgen_ty_4 = 6;
pub const SND_SEQ_EVFLG_SAMPLE: _bindgen_ty_4 = 7;
pub const SND_SEQ_EVFLG_USERS: _bindgen_ty_4 = 8;
pub const SND_SEQ_EVFLG_INSTR: _bindgen_ty_4 = 9;
pub const SND_SEQ_EVFLG_QUOTE: _bindgen_ty_4 = 10;
pub const SND_SEQ_EVFLG_NONE: _bindgen_ty_4 = 11;
pub const SND_SEQ_EVFLG_RAW: _bindgen_ty_4 = 12;
pub const SND_SEQ_EVFLG_FIXED: _bindgen_ty_4 = 13;
pub const SND_SEQ_EVFLG_VARIABLE: _bindgen_ty_4 = 14;
pub const SND_SEQ_EVFLG_VARUSR: _bindgen_ty_4 = 15;
pub type _bindgen_ty_4 = u32;
pub const SND_SEQ_EVFLG_NOTE_ONEARG: _bindgen_ty_5 = 0;
pub const SND_SEQ_EVFLG_NOTE_TWOARG: _bindgen_ty_5 = 1;
pub type _bindgen_ty_5 = u32;
pub const SND_SEQ_EVFLG_QUEUE_NOARG: _bindgen_ty_6 = 0;
pub const SND_SEQ_EVFLG_QUEUE_TICK: _bindgen_ty_6 = 1;
pub const SND_SEQ_EVFLG_QUEUE_TIME: _bindgen_ty_6 = 2;
pub const SND_SEQ_EVFLG_QUEUE_VALUE: _bindgen_ty_6 = 3;
pub type _bindgen_ty_6 = u32;
extern "C" {
    #[link_name = "\u{1}snd_seq_event_types"]
