...
#[no_mangle]
pub unsafe extern "C" fn waveOutProc(hWaveOut : mmsystem::HWAVEOUT, uMsg : u32,
                                     dwInstance : usize, dwParam1 : usize, dwParam2 : usize)
{
...
impl WinPlayer {
    fn init(&mut self) {
        ...
        unsafe {
    	    ...
    	    if mmeapi::waveOutOpen(&mut hWaveOut, mmsystem::WAVE_MAPPER, &mut wfx,
                wp as usize, thiz as usize, mmsystem::CALLBACK_FUNCTION)
